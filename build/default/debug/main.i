...
# 192 "main.c"
        ...
        if(buffer[0] == 'k')
        {
            ...
            if((cdc_trf_state == 0))
            {
                ...
                for(unsigned char PUTUSBUSART_ROW_K = 0; PUTUSBUSART_ROW_K < 2; PUTUSBUSART_ROW_K++)
                {
                    for(unsigned char PUTUSBUSART_COL_K = 0; PUTUSBUSART_COL_K < 8; PUTUSBUSART_COL_K++)
                    {
                        unsigned short testvar1 = measarray[PUTUSBUSART_ROW_K][PUTUSBUSART_COL_K];
                        putUSBUSART(&testvar1,2);
                    }
                }
            }
        }

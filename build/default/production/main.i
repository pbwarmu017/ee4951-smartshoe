...
# 1 "C:/Users/Paul MacGregor/.mchp_packs/Microchip/PIC12-16F1xxx_DFP/1.2.63/xc8\\pic\\include\\__null.h" 1 3
...
# 10 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\include\\c99\\limits.h" 3
    ...
    while (1)
    {
        ...
        else
        {
            ...
            if(!((USBInHandle != 0x0000) && ((*(volatile uint8_t*)USBInHandle & 0x80) != 0x00)))
            {
                ...
                USBInHandle = USBTransferOnePacket(0x81,1,(uint8_t*)&data[0],sizeof(data));
            }
        }
    }
}

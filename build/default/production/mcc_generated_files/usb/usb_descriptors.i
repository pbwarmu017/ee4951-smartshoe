# 1 "mcc_generated_files/usb/usb_descriptors.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/usb/usb_descriptors.c" 2
# 146 "mcc_generated_files/usb/usb_descriptors.c"
...
# 146 "mcc_generated_files/usb/usb_descriptors.c" 2
# 155 "mcc_generated_files/usb/usb_descriptors.c"
...
# 235 "mcc_generated_files/usb/usb_descriptors.c"
...
const uint8_t *const USB_SD_Ptr[4]=
{
    ...
    const MS_COMPAT_ID_FEATURE_DESC CompatIDFeatureDescriptor =
    {
        ...
        sizeof(CompatIDFeatureDescriptor),
        0x0100,
        (uint16_t)0x0004,
        0x01,
        {0,0,0,0,0,0,0},
    ...
    const MS_EXT_PROPERTY_FEATURE_DESC ExtPropertyFeatureDescriptor =
    {
        ...
        sizeof(ExtPropertyFeatureDescriptor),
        0x0100,
        (uint16_t)0x0005,
        0x0001,
        ...
        0x00000001,
        40,
        {'D','e','v','i','c','e','I','n','t','e','r','f','a','c','e','G','U','I','D', 0x0000},
        78,
# 313 "mcc_generated_files/usb/usb_descriptors.c"
